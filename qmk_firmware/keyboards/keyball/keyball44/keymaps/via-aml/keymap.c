...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_LSFT , KC_A     , KC_S     , LT(3,KC_D),KC_F     , KC_G     ,                            KC_H     , KC_J     , KC_K     , KC_L     , LT(3,KC_ENT), KC_BSPC  ,
    KC_LALT , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                            KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_DEL  , _______  ,
              TG(4)    , KC_PSCR  , KC_LGUI  , LCTL_T(KC_TAB),KC_INT2,                          LT(2,KC_CAPS),LT(1,KC_SPC), _______ , _______ , TG(5)
  ),
  ...
  [4] = LAYOUT_universal(
    ...
    _______  , AML_I50  , AML_D50  , _______  , _______  , _______  ,                            RGB_VAI  , RGB_TOG  , _______  , _______ , _______ , _______ ,
    _______  , _______  , _______  , _______  , _______  , _______  ,                            RGB_VAD  , _______  , _______  , _______ , _______ , _______ ,
               QK_BOOT  , QK_RBT   , TG(4)    , _______  , _______  ,                            TO(0)    , _______  , _______  , _______ , _______
  ),
  
  [5] = LAYOUT_universal(
    _______  , _______  , _______  , _______  , _______  , _______ ,                             _______  , _______  , _______  , _______ , _______ , _______ ,
    _______  , _______  , _______  , _______  , _______  , _______ ,                             _______  , KC_BTN1  , SCRL_MO  , KC_BTN2 , KC_ENT  , _______ ,
    _______  , _______  , _______  , _______  , _______  , _______ ,                             _______  , KC_BTN4  , KC_BTN3  , KC_BTN5 , KC_BSPC , _______ ,
               _______  , _______  , _______  , _______  , _______  ,                            TO(0)    , _______  , _______  , _______ , TG(5)
  ),
